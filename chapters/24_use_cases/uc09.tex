\begin{usecase}{PU09 Přihlašování}{uc09}
    ...
    \begin{scenario}{HS: Zobrazení tlačítka}{uc09:hs}
        ...
        \item Pokud uživatel není přihlášen, pak aplikace zobrazí tlačítko \uv{Přihlásit}, pole pro vyplnění přihlašovacího jména a hesla.
        \item Jinak aplikace zobrazí tlačítko \uv{Odhlásit}.
    \end{scenario}


    \begin{scenario}{AS01: Přihlášení}{uc09:as01}
        \item Scénář začne po stisknutí tlačítka \uv{Přihlásit}
    ...
    \begin{scenario}{AS02: Odhlášení}{uc09:as02}
        \item Scénář začne po stisknutí tlačítka \uv{Odhlásit}.
